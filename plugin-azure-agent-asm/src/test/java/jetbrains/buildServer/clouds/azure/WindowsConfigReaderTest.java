...
public class WindowsConfigReaderTest {
    ...
    public void testProcessWindowsConfig() throws IOException {
        ...
        m.checking(new Expectations() {{
            ...
            one(agentConfiguration).getAlternativeAddresses();
        ...
        new WindowsCustomDataReader(agentConfiguration, idleShutdown, fileUtils).process();
        new WindowsConfigReader(agentConfiguration, fileUtils).process();
