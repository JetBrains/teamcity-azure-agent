...
public class AzurePropertiesReaderTest {
  ...
  @Test
  public static void testSharedConfig() throws IOException, JDOMException {
    final String xmlData = FileUtil.readText(new File("src/test/resources/SharedConfig.xml"));
  ...
  public void testCustomData() throws JDOMException, IOException {
    final String xmlData = FileUtil.readText(new File("src/test/resources/ovf-env.xml"));
  ...
  public void deserializeCustomDataWindows() throws IOException {
    final String xmlData = FileUtil.readText(new File("src/test/resources/CustomData.bin"));
    final CloudInstanceUserData deserialize = CloudInstanceUserData.deserialize(xmlData);
